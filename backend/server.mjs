...
const FACEBOOK_APP_ID = 1545654042919320;
const FACEBOOK_APP_SECRET = "504d5d5545db6518d157b99d3c777a40";
  ...
  new FacebookStrategy(
    {
      ...
      // Your callback URL
      callbackURL: 'https://psychic-funicular-grx7577v5gr29pp4-5050.app.github.dev/facebook/callback', 
...
app.get('/facebook/callback', passport.authenticate('facebook', {
  ...
  successRedirect: 'https://psychic-funicular-grx7577v5gr29pp4-3000.app.github.dev/home', 
  // Redirect to login page on authentication failure.
  failureRedirect: 'https://psychic-funicular-grx7577v5gr29pp4-3000.app.github.dev', 
}));
